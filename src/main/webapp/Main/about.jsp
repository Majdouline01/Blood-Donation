...
<body>
 <header>
		...
		<ul class="nav-links">
			...
			<li><a href="../Main/about.jsp" class="active">A propos</a></li>
	...
	<div class="container">
      ...
      <div class="img-container">
        <img src="https://dummyimage.com/600x400/cccccc/ffffff" alt="Image de groupe">
        <p>Nous sommes une équipe passionnée de professionnels de la santé et de développeurs dévoués à la promotion du don de sang. Nous sommes convaincus que chaque don de sang compte et qu'il peut sauver des vies. Notre mission est de rendre le processus de don de sang facile, sûr et accessible à tous.</p>
      </div>
